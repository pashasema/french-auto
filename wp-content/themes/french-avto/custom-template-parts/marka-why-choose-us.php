			...
			<div class="col-12 col-lg-6">
				...
				<div class="why-choose-us__special-offer">
					...
					<?php if( $offer ): ?>
						...
						<p class="why-choose-us__special-offer-text"><?php echo the_field('special_offer_text_before','option'); ?> <?php echo($taxonomy->name); ?> <?php echo the_field('special_offer_text_after','option'); ?></p>
					<?php endif; ?>
