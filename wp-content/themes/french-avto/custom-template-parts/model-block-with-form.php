		...
		<div class="row justify-content-center">
			...
			<div class="col-12 col-md-4">
				...
				<div class="block-with-form__item">
					...
					<p class="block-with-form__item-text">Бесплатная диагностика ходовой <?php echo($category_parent->name); ?> <?php echo($taxonomy->name); ?> в день обращения</p>
			...
			<div class="col-12 col-md-4">
				...
				<div class="block-with-form__item">
					...
					<p class="block-with-form__item-text">Бесплатная проверка и долив рабочих жидкостей <?php echo($category_parent->name); ?> <?php echo($taxonomy->name); ?></p>
				...
				<div class="col-12 col-lg-4">
					...
					<div class="contact-form block-with-form__contact-form">
						<form class="form block-with-form__form" method="POST">
							...
							<input name="usluga" value="Клиент хочет оставить заявку и получить бонусы для <?php echo($category_parent->name); ?> <?php echo($taxonomy->name); ?>" type="hidden">
