	<section class="calculation services-section-margin">
		<div class="all-titles-wrap">
			<h2 class="all-titles calculation__title">Расчет стоимости ремонта</h2>
			<span class="devider"><span></span></span>
		</div>
		<p class="calculation__text">Мы произведем расчет стоимости ремонта вашего авто</p>
			...
			<div class="col-12 col-lg-6">
				...
				<div class="contact-form calculation__contact-form">
					<form class="form calculation__form" method="POST">
						...
						<input name="usluga" value="Клиент хочет расчитать стоимость" type="hidden">
