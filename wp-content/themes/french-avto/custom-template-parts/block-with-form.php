		...
		<div class="row justify-content-center">
			...
			<div class="col-12 col-md-4">
				...
				<div class="block-with-form__item">
					...
					<p class="block-with-form__item-text">Бесплатная диагностика ходовой Peugeot, Citroen, Renault в день обращения</p>
			...
			<div class="col-12 col-md-4">
				...
				<div class="block-with-form__item">
					...
					<p class="block-with-form__item-text">Бесплатная проверка и долив рабочих жидкостей Peugeot, Citroen, Renault</p>
				...
				<div class="col-12 col-lg-4">
					...
					<div class="contact-form block-with-form__contact-form">
						<form class="form block-with-form__form" method="POST">
							...
							<input name="usluga" value="Клиент хочет оставить заявку и получить бонусы" type="hidden">
